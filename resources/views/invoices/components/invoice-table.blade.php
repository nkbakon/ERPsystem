<div class="overflow-x-auto">
    <div class="flex w-full p-3 space-x-2">
        ...
        <div class="w-3/6">
            ...
            focus:outline-none focus:shadow-outline focus-ring-0 foucus:bg-indigo-50" placeholder="Search Invoices...">
        </div>
        <!-- Order By -->
        <div class="w-1/6">
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">                                    
                ...
                <td class="hidden">
                    ...
                    @for ($i = 0; $i < count($item_ids); $i++)
                        {{ App\Models\Item::find($item_ids[$i])->code }} - {{ App\Models\Item::find($item_ids[$i])->name }} - {{ App\Models\Item::find($item_ids[$i])->category->name }} - {{ App\Models\Item::find($item_ids[$i])->subcategory->name }} : {{ $quantities[$i] }},
                    @endfor                                   
                </td>                
                <td class="hidden">
    ...
    <div class="relative w-full h-full max-w-md md:h-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6">
                ...
                <div>
                    <strong>Invoice ID : </strong><span id="view_id"></span><br> 
                    <strong>Items : </strong><br><span id="view_items"></span>
                    <strong>Total Quantity : </strong><span id="view_totalquantity"></span><br>
                    <strong>Total : </strong>LKR <span id="view_total"></span><br>
    ...
    <div class="relative w-full h-full max-w-md md:h-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 text-center">
                <form method="POST" action="{{ route('invoices.destroy', 'data_id') }}">
                    @csrf
                    @method('DELETE')
...
<script>
    ...
    $(document).ready(function(){
        $('.viewBtn').on('click', function(){
            ...
            document.getElementById('view_items').innerHTML = data[3].replaceAll(',', '<br>');
            document.getElementById('view_totalquantity').innerHTML = data[4];
            document.getElementById('view_total').innerHTML = data[5];
