<div class="overflow-x-auto">
    <div class="flex w-full p-3 space-x-2">
        ...
        <div class="w-3/6">
            ...
            focus:outline-none focus:shadow-outline focus-ring-0 foucus:bg-indigo-50" placeholder="Search Items...">
        </div>
        <!-- Order By -->
        <div class="w-1/6">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6">
                ...
                <div>
                    ...
                    <strong>Item Code : </strong><span id="view_code"></span><br>
                    <strong>Category : </strong><span id="view_category"></span><br>
                    <strong>Sub-Category : </strong><span id="view_subcategory"></span><br>
    ...
    <div class="relative w-full h-full max-w-md md:h-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 text-center">
                <form method="POST" action="{{ route('items.destroy', 'data_id') }}">
                    @csrf
                    @method('DELETE')
...
<script>
    ...
    $(document).ready(function(){
        $('.viewBtn').on('click', function(){
            ...
            document.getElementById('view_code').innerHTML = data[1];
            document.getElementById('view_name').innerHTML = data[2];
            document.getElementById('view_category').innerHTML = data[3];
            document.getElementById('view_subcategory').innerHTML = data[4];
            document.getElementById('view_quantity').innerHTML = data[5];
            document.getElementById('view_price').innerHTML = data[6];
            document.getElementById('view_addby').innerHTML = data[7];
            document.getElementById('view_adddate').innerHTML = data[8];
            document.getElementById('view_editby').innerHTML = data[9];
            document.getElementById('view_editdate').innerHTML = data[10];
