        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6">
                ...
                <div>
                    ...
                    <strong>District : </strong><span id="view_district"></span><br>  
...
<script>
    ...
    $(document).ready(function(){
        $('.viewBtn').on('click', function(){
            ...
            document.getElementById('view_contact').innerHTML = data[2];
            document.getElementById('view_district').innerHTML = data[3];
            document.getElementById('view_addby').innerHTML = data[4];
            document.getElementById('view_adddate').innerHTML = data[5];
            document.getElementById('view_editby').innerHTML = data[6];
            document.getElementById('view_editdate').innerHTML = data[7];
